...
/// 遵循 Apple HIG 规范与 WCAG 4.5:1 对比度标准，展示字级阶梯、语义黑白灰阶、Bad vs Good 实测及 Aura 标杆组件
public struct TypographyShowcaseView: View {
    ...
    private var headerSection: some View {
        VStack(alignment: .leading, spacing: DesignSystem.Spacing.small) {
            ...
            Text("排版字阶规范、语义对比度约束与 Aura 风格标杆实测")
    ...
    private var practicalComponentSection: some View {
        VStack(alignment: .leading, spacing: DesignSystem.Spacing.medium) {
            sectionHeader(title: "Aura 标杆组件实装效果", icon: "square.stack.3d.up.fill")
